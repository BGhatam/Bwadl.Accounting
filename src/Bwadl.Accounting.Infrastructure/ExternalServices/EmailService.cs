...
namespace Bwadl.Accounting.Infrastructure.ExternalServices;
...
public class EmailService : IEmailService
{
    ...
    private async Task<Bwadl.Accounting.Shared.Configuration.EmailServiceOptions> GetEmailServiceConfigurationAsync()
    {
        var externalServiceOptions = await _configurationService.GetOptionsAsync<Bwadl.Accounting.Shared.Configuration.ExternalServiceOptions>();
        return externalServiceOptions.EmailService;
    }
}
